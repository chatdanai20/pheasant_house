...
class CardNotificationTemp extends StatefulWidget {
  final String farmName;

  const CardNotificationTemp({Key? key, required this.farmName})
      : super(key: key);
  @override
  State<CardNotificationTemp> createState() => _CardNotificationTempState();
}

class _CardNotificationTempState extends State<CardNotificationTemp> {
      ...
      builder:
        ...
        return Container(
          ...
          child: Column(
            children: [
              sizedBox,
              Image.asset('asset/images/temperature.png'),
              const SizedBox(
                height: 50,
              ),
              const Row(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    decoration: const InputDecoration(
                                      labelText: "ตั้งค่าอุณหภูมิสูงสุด",
                                    ),
                                  ...
                                  TextFormField(
                                    decoration: const InputDecoration(
                                      labelText: "ตั้งค่าอุณหภูมิต่ำสุด",
                                    ),
                                    keyboardType: TextInputType.number,
                                    controller: _notification_min,
                                  ),
