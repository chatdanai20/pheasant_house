...
class ChartBar3 extends StatefulWidget {
  final DateTime? selectedDate; // Add this line
  final String email; // Add this line
  final String farmName; // Add this line

  const ChartBar3({super.key, this.selectedDate, required this.email, required this.farmName}); // Add this line

  @override
  State<StatefulWidget> createState() => ChartBar3State();
}

class ChartBar3State extends State<ChartBar3> {
